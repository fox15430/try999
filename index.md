...
<body onresize=hero();>
       <div id="冲塑模在製套數" style="width: 600px;height: 400px;positon:absolute;left:450px;top:80px;border:300x solid red"></div>
       <div id="人力分佈" style="width: 500px;height: 330px;positon:absolute;left:000px;top:-900px;border:800x solid red"></div>
       <div id="人員出勤" style="width: 400px;height: 350px;positon:absolute;left:1650px;top:-1230px;border:300x solid red"></div>
       <div id="人力結構" style="width: 500px;height: 330px;positon:absolute;left:000px;top:-1230px;border:300x solid red"></div>
       <div id="自動化相關工作承接" style="width: 600px;height: 400px;positon:absolute;left:1050px;top:-1330px;border:300x solid red"></div>
       <div id="main6" style="width: 500px;height: 300px;positon:absolute;left:000px;top:-1620px;border:300x solid red"></div>
       <div id="工時月報表" style="width: 400px;height: 300px;positon:absolute;left:1650px;top:-1930px;border:300x solid red"></div>
       <div id="工時週報表" style="width: 380px;height: 300px;positon:absolute;left:1670px;top:-2550px;border:300x solid red"></div>
    ...
    <script type="text/javascript">
        ...
        var myChart1=echarts.init(document.getElementById('冲塑模在製套數'),'roma');
        //指定?表的配置?和?据
option = {
    title : {
...
window.addEventListener("resize",function(){
        ...
        var myChart8=echarts.init(document.getElementById('工時週報表'),'roma');
        //指定?表的配置?和?据
option = {
    title : {
